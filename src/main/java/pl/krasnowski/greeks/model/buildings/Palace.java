...
@Entity
public class Palace extends ABuilding {
	@Column
	...
	public Palace(int lvl, int nWood, long nTime, int nWine, int nMarble, int nCrystal, int nSulphur) {
	...
	public String toString() {
		return "Palace [lvl=" + lvl + ", nWood=" + nWood + ", nTime=" + nTime + ", nWine=" + nWine + ", nMarble=" + nMarble + ", nCrystal=" + nCrystal + ", nSulphur=" + nSulphur + "]";
	}
