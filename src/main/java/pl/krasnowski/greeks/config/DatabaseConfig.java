...
public class DatabaseConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setPassword(env.getProperty("pring.datasource.password"));
		return dataSource;
	}
	...
	/**
	 * PersistenceExceptionTranslationPostProcessor is a bean post processor which adds an advisor to any bean annotated with Repository so that any platform-specific exceptions are caught and then
	 * rethrown as one Spring's unchecked data access exceptions (i.e. a subclass of DataAccessException).
	 */
	@Bean
